...
from pyCore.models import add_column_to_schema
...
import pyCore.plugins.helpers as helpers
...
def load_environment(settings, config, apppath, policy_array):
    ...
    config.add_translation_dirs('pyCore:locale')
    config.add_subscriber('pyCore.i18n.i18n.add_renderer_globals', 'pyramid.events.BeforeRender')
    config.add_subscriber('pyCore.i18n.i18n.add_localizer', 'pyramid.events.NewRequest')
