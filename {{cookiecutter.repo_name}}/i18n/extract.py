...
import stock.config.jinja_extensions as je

jinja_extensions = '''
                    jinja2.ext.do, jinja2.ext.i18n,                    
                    stock.config.jinja_extensions.JSResourceExtension,
                    stock.config.jinja_extensions.CSSResourceExtension,
                    stock.config.jinja_extensions.extendThis,
                   '''
...
def extract_stock(fileobj, *args, **kw):
